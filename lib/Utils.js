...
function convertRTPProperties(rtp)
{
	...
	if (rtp.audio)
	{
		...
		{
			 //Set properties
			properties.SetPropertyInt("audio.ext."+num+".id"	,parseInt(id));
			properties.SetPropertyStr("audio.ext."+num+".uri"	,String(uri));
			//one more
			num++;
		}
		//Set length
	...
	if (rtp.video)
	{
		...
		{
			 //Set properties
			properties.SetPropertyInt("video.ext."+num+".id"	, parseInt(id));
			properties.SetPropertyStr("video.ext."+num+".uri"	, String(uri));
			//one more
			num++;
		}
		//Set length
