...
class Player
{
	...
	constructor(filename)
	{
		...
		if (this.player.HasVideoTrack())
		{
			...
			//Create new track
			const incomingStreamTrack = new IncomingStreamTrack("video",trackId,null,null,[source]);
		...
		if (this.player.HasAudioTrack())
		{
			...
			//Create new track
			const incomingStreamTrack = new IncomingStreamTrack("audio",trackId,null,null,[source]);
